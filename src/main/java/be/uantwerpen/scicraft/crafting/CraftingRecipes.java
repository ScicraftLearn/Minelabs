...
public class CraftingRecipes {
    ...
    public static RecipeType<MoleculeRecipe> MOLECULE_CRAFTING = RecipeType.register("molecule_crating");
    ...
    public static void register() {
        ...
        Registry.register(Registry.RECIPE_SERIALIZER, new Identifier(Scicraft.MOD_ID, "molecule_crating"), MoleculeRecipe.MoleculeRecipeSerializer.INSTANCE);
    }
