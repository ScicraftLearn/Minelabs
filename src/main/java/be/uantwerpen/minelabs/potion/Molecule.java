...
public enum Molecule {
    ...
    BH3("BH3", 0xFFFFFF, Arrays.asList(new FlammableReaction(20*3), new PoisonousReaction(4, 400, 1))),
    HF("HF", 0xFFFFFF, Arrays.asList(new PoisonousReaction(4, 400, 1))),
    SIH4("SiH4", 0xFFFFFF, Arrays.asList(new FlammableReaction(20*3))),
    PH3("PH3", 0xFFFFFF, Arrays.asList(new FlammableReaction(20*3), new PoisonousReaction(5, 800, 2), new CorrosiveReaction())),
