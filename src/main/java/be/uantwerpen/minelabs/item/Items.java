...
public class Items {
   ...
   /* public static final Item LAB_COAT = register(new ArmorItem(ArmorMaterials.CLOTH, EquipmentSlot.CHEST,
            new FabricItemSettings()), "lab_coat");*/
    ...
    public static final Item UPQUARK_QUANTUMFIELD = register(new BlockItem(Blocks.UPQUARK_QUANTUMFIELD, new FabricItemSettings()), "upquark_quantumfield");
    public static final Item DOWNQUARK_QUANTUMFIELD = register(new BlockItem(Blocks.DOWNQUARK_QUANTUMFIELD, new FabricItemSettings()), "downquark_quantumfield");
    public static final Item GLUON_QUANTUMFIELD = register(new BlockItem(Blocks.GLUON_QUANTUMFIELD, new FabricItemSettings()), "gluon_quantumfield");
    public static final Item ELECTRON_QUANTUMFIELD = register(new BlockItem(Blocks.ELECTRON_QUANTUMFIELD, new FabricItemSettings()), "electron_quantumfield");
    public static final Item PHOTON_QUANTUMFIELD = register(new BlockItem(Blocks.PHOTON_QUANTUMFIELD, new FabricItemSettings()), "photon_quantumfield");
    public static final Item NEUTRINO_QUANTUMFIELD = register(new BlockItem(Blocks.NEUTRINO_QUANTUMFIELD, new FabricItemSettings()), "neutrino_quantumfield");
    public static final Item WEAK_BOSON_QUANTUMFIELD = register(new BlockItem(Blocks.WEAK_BOSON_QUANTUMFIELD, new FabricItemSettings()), "weak_boson_quantumfield");
    ...
    public static final Item UPQUARK_RED = register(new Item(new Item.Settings().maxCount(64)), "upquark_red");
    public static final Item UPQUARK_GREEN = register(new Item(new Item.Settings().maxCount(64)), "upquark_green");
    public static final Item UPQUARK_BLUE = register(new Item(new Item.Settings().maxCount(64)), "upquark_blue");
    public static final Item ANTI_UPQUARK_RED = register(new Item(new Item.Settings().maxCount(64)), "anti_upquark_red");
    public static final Item ANTI_UPQUARK_GREEN = register(new Item(new Item.Settings().maxCount(64)), "anti_upquark_green");
    public static final Item ANTI_UPQUARK_BLUE = register(new Item(new Item.Settings().maxCount(64)), "anti_upquark_blue");
    public static final Item DOWNQUARK_RED = register(new Item(new Item.Settings().maxCount(64)), "downquark_red");
    public static final Item DOWNQUARK_GREEN = register(new Item(new Item.Settings().maxCount(64)), "downquark_green");
    public static final Item DOWNQUARK_BLUE = register(new Item(new Item.Settings().maxCount(64)), "downquark_blue");
    public static final Item ANTI_DOWNQUARK_RED = register(new Item(new Item.Settings().maxCount(64)), "anti_downquark_red");
    public static final Item ANTI_DOWNQUARK_GREEN = register(new Item(new Item.Settings().maxCount(64)), "anti_downquark_green");
    public static final Item ANTI_DOWNQUARK_BLUE = register(new Item(new Item.Settings().maxCount(64)), "anti_downquark_blue");

    public static final Item GLUON = register(new Item(new Item.Settings().maxCount(64)), "gluon");

    public static final Item ELECTRON = register(new SubatomicParticleItem(Blocks.ELECTRON, new Item.Settings().maxCount(64)), "electron");
    public static final Item POSITRON = register(new SubatomicParticleItem(Blocks.POSITRON, new Item.Settings().maxCount(64)), "positron");
    public static final Item PHOTON = register(new Item(new Item.Settings().maxCount(64)), "photon");

    public static final Item NEUTRINO = register(new BlockItem(Blocks.NEUTRINO, new FabricItemSettings()), "neutrino");
    public static final Item ANTINEUTRINO = register(new BlockItem(Blocks.ANTINEUTRINO, new FabricItemSettings()), "antineutrino");
    public static final Item WEAK_BOSON = register(new BlockItem(Blocks.WEAK_BOSON, new FabricItemSettings()), "weak_boson");

    public static final Item PROTON = register(new SubatomicParticleItem(Blocks.PROTON, new Item.Settings().maxCount(64)), "proton");
    public static final Item ANTI_PROTON = register(new SubatomicParticleItem(Blocks.ANTI_PROTON, new Item.Settings().maxCount(64)), "anti_proton");
    public static final Item NEUTRON = register(new SubatomicParticleItem(Blocks.NEUTRON, new Item.Settings().maxCount(64)), "neutron");
    public static final Item ANTI_NEUTRON = register(new SubatomicParticleItem(Blocks.ANTI_NEUTRON, new Item.Settings().maxCount(64)), "anti_neutron");
    public static final Item PION_NUL = register(new BlockItem(Blocks.PION_NUL, new FabricItemSettings()), "pion_nul");
    public static final Item PION_MINUS = register(new BlockItem(Blocks.PION_MINUS, new FabricItemSettings()), "pion_minus");
    public static final Item PION_PLUS = register(new BlockItem(Blocks.PION_PLUS, new FabricItemSettings()), "pion_plus");

    //public static final Item CHARGED_BLOCK = register(new BlockItem(Blocks.CHARGED_BLOCK, new FabricItemSettings(), "charged_block");
    ...
    public static final Item ERLENMEYER_STAND = register(new BlockItem(Blocks.ERLENMEYER_STAND,
            new FabricItemSettings()), "erlenmeyer_stand");
    public static final Item ERLENMEYER = register(new ErlenmeyerItem(net.minecraft.fluid.Fluids.EMPTY,
            new Item.Settings(), ""), "erlenmeyer");

    public static final Item ERLENMEYER_O2 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.O2), "erlenmeyer_o2");
    public static final Item ERLENMEYER_N2 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.N2), "erlenmeyer_n2");
    public static final Item ERLENMEYER_CH4 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.CH4), "erlenmeyer_ch4");
    public static final Item ERLENMEYER_H2 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.H2), "erlenmeyer_h2");
    public static final Item ERLENMEYER_NO = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.NO), "erlenmeyer_no");
    public static final Item ERLENMEYER_NO2 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.NO2), "erlenmeyer_no2");
    public static final Item ERLENMEYER_Cl2 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.CL2), "erlenmeyer_cl2");
    public static final Item ERLENMEYER_CO2 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.CO2), "erlenmeyer_co2");
    public static final Item ERLENMEYER_CO = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.CO), "erlenmeyer_co");
    public static final Item ERLENMEYER_NH3 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.NH3), "erlenmeyer_nh3");
    public static final Item ERLENMEYER_N2O = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.N2O), "erlenmeyer_n2o");
    public static final Item ERLENMEYER_HCl = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.HCL), "erlenmeyer_hcl");
    public static final Item ERLENMEYER_He = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.HE), "erlenmeyer_he");
    public static final Item ERLENMEYER_Ne = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.NE), "erlenmeyer_ne");
    public static final Item ERLENMEYER_Ar = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.AR), "erlenmeyer_ar");
    public static final Item ERLENMEYER_CL2O = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.CL2O), "erlenmeyer_cl2o");
    public static final Item ERLENMEYER_CH4S = register(new GasPotion(
            new FabricItemSettings().recipeRemainder(ERLENMEYER), Molecule.CH4S), "erlenmeyer_methanethiol");
    public static final Item ERLENMEYER_CH2O = register(new GasPotion(
            new FabricItemSettings().recipeRemainder(ERLENMEYER), Molecule.CH2O), "erlenmeyer_formaldehyde");
    public static final Item ERLENMEYER_H2CO3 = register(new GasPotion(
            new FabricItemSettings().recipeRemainder(ERLENMEYER), Molecule.H2CO3), "erlenmeyer_carbonic_acid");
    public static final Item ERLENMEYER_BH3 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.BH3), "erlenmeyer_bh3");
    public static final Item ERLENMEYER_HF = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.HF), "erlenmeyer_hf");
    public static final Item ERLENMEYER_SIH4 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.SIH4), "erlenmeyer_sih4");
    public static final Item ERLENMEYER_PH3 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.PH3), "erlenmeyer_ph3");
    public static final Item ERLENMEYER_H2S = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.H2S), "erlenmeyer_h2s");
    public static final Item ERLENMEYER_CF4 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.CF4), "erlenmeyer_cf4");
    public static final Item ERLENMEYER_BF3 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.BF3), "erlenmeyer_bf3");
    public static final Item ERLENMEYER_BCL3 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.BCL3), "erlenmeyer_bcl3");
    public static final Item ERLENMEYER_SO2 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.SO2), "erlenmeyer_so2");
    public static final Item ERLENMEYER_CLF = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.CLF), "erlenmeyer_clf");
    public static final Item ERLENMEYER_F2 = register(new GasPotion(
            new Item.Settings().recipeRemainder(ERLENMEYER), Molecule.F2), "erlenmeyer_f2");

    public static final Item ERLENMEYER_HNO3 = register(new ErlenmeyerItem(
            Fluids.STILL_HNO3, new Item.Settings().recipeRemainder(ERLENMEYER), "HNO3"), "erlenmeyer_hno3");
    public static final Item ERLENMEYER_H2O = register(new ErlenmeyerItem(
            Fluids.STILL_H2O, new Item.Settings().recipeRemainder(ERLENMEYER), "H2O"), "erlenmeyer_h2o");
    public static final Item ERLENMEYER_NCL3 = register(new ErlenmeyerItem(
            Fluids.STILL_NCl3, new Item.Settings().recipeRemainder(ERLENMEYER), "NCl3"), "erlenmeyer_ncl3");
    public static final Item ERLENMEYER_CS2 = register(new ErlenmeyerItem(
            Fluids.STILL_CS2, new Item.Settings().recipeRemainder(ERLENMEYER), "CS2"), "erlenmeyer_cs2");
    public static final Item ERLENMEYER_CCL4 = register(new ErlenmeyerItem(
            Fluids.STILL_CCl4, new Item.Settings().recipeRemainder(ERLENMEYER), "CCl4"), "erlenmeyer_ccl4");
    public static final Item ERLENMEYER_PCl3 = register(new ErlenmeyerItem(
            Fluids.STILL_PCl3, new Item.Settings().recipeRemainder(ERLENMEYER), "PCl3"), "erlenmeyer_pcl3");
    public static final Item ERLENMEYER_SCl2 = register(new ErlenmeyerItem(
            Fluids.STILL_SCl2, new Item.Settings().recipeRemainder(ERLENMEYER), "SCl2"), "erlenmeyer_scl2");
    public static final Item ERLENMEYER_HCN = register(new ErlenmeyerItem(
            Fluids.STILL_HCN, new Item.Settings().recipeRemainder(ERLENMEYER), "HCN"), "erlenmeyer_hcn");
    public static final Item ERLENMEYER_CH4O = register(new ErlenmeyerItem(
            Fluids.STILL_CH4O, new Item.Settings().recipeRemainder(ERLENMEYER), "CH4O"), "erlenmeyer_ch4o");
    public static final Item ERLENMEYER_SICL4 = register(new ErlenmeyerItem(
            Fluids.STILL_SiCl4, new Item.Settings().recipeRemainder(ERLENMEYER), "SiCl4"), "erlenmeyer_sicl4");
