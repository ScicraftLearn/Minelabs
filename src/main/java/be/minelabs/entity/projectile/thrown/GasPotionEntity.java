...
public class GasPotionEntity extends PotionEntity { // TODO: better to extends from ThrownItemEntity, but the throw animation is buggy

    private final Molecule molecule;

    public GasPotionEntity(World world, LivingEntity player, Molecule molecule) {
        super(world, player);
