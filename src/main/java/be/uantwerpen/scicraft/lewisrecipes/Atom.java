...
public enum Atom {
    ...
    POTASSIUM(19, "K", 0.8, AtomType.METAL, 1, 20, Items.POTASSIUM_ATOM),
    CALCIUM(20, "Ca", 1.0, AtomType.METAL, 2, 20, Items.CALCIUM_ATOM),
    IRON(26, "Fe", 1.8, AtomType.METAL, 2, 30, Items.IRON_ATOM), /*Valence electrons may not be correct */
    COPPER(29, "Cu", 1.9, AtomType.METAL, 1, 34, Items.COPPER_ATOM), /*Valence electrons may not be correct */
    ZINC(30, "Zn", 1.6, AtomType.METAL, 2, 34, Items.ZINC_ATOM), /*Valence electrons may not be correct */
    BROMINE(35, "Br", 2.8, AtomType.NON_METAL, 7, 44, Items.BROMINE_ATOM),

    SILVER(47, "Ag", 1.9, AtomType.METAL, 1, 60, Items.SILVER_ATOM), /*Valence electrons may not be correct */
    CADMIUM(48, "Cd", 1.7, AtomType.METAL, 2, 66, Items.CADMIUM_ATOM), /*Valence electrons may not be correct */
    TIN(50, "Sn", 1.8, AtomType.METAL, 4, 70, Items.TIN_ATOM),
    IODINE(53, "I", 2.5, AtomType.NON_METAL, 7, 74, Items.IODINE_ATOM),

    GOLD(79, "Au", 2.4, AtomType.METAL, 1, 118, Items.GOLD_ATOM), /*Valence electrons may not be correct */
    MERCURY(80, "Hg", 2, AtomType.METAL, 2, 122, Items.MERCURY_ATOM), /*Valence electrons may not be correct */
    LEAD(82, "Pb", 1.8, AtomType.METAL, 4, 126, Items.LEAD_ATOM),
    URANIUM(92, "U", 1.7, AtomType.METAL, 2, 146, Items.URANIUM_ATOM); /*Valence electrons may not be correct */
