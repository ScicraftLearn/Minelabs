...
public class PionPlusBlock extends BlockWithEntity {
    ...
    public PionPlusBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new PionPlusBlockEntity(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, BlockEntities.PION_PLUS_BLOCK_ENTITY, PionPlusBlockEntity::tick);
    }
}
