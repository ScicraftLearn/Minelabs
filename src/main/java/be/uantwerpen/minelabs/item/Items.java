...
public class Items {
    ...
    public static final Item CHARGED_POINT = register(new BlockItem(Blocks.CHARGED_POINT_BLOCK, new FabricItemSettings().group(ItemGroups.ELEMENTARY_PARTICLES)), "charged_point");
    ...
    private static AtomItem registerAtom(Atom atom){
        AtomItem item = register(new AtomItem(new Item.Settings().group(ItemGroups.ATOMS), atom), atom.getItemId());
        atom.setItem(item);
        return item;
    }
