...
public enum Molecule {
    ...
    CH4("CH4", 0xAFAFAF, List.of(new FlammableReaction(20*3, false))),
    H2("H2", 0xAFAFAF, Arrays.asList(new ExplosiveReaction(1, false))),
    NO("NO", 0xAFAFAF, Arrays.asList()),
    NO2("NO2", 0x991c00, Arrays.asList()),
    CL2("CL2", 0xE8F48C, List.of(new PoisonousReaction(2, 200, 1))),
    CO2("CO2", 0xAFAFAF, Arrays.asList(new ExtinguishReaction())),
    ...
    HCL("HCl", 0xAFAFAF, Arrays.asList(new CorrosiveReaction(), new DissolveReaction())),
    ...
    BH3("BH3", 0xFFFFFF, Arrays.asList(new FlammableReaction(20*3, false), new PoisonousReaction(4, 400, 1))),
    HF("HF", 0xFFFFFF, Arrays.asList(new PoisonousReaction(4, 400, 1))),
    SIH4("SiH4", 0xFFFFFF, Arrays.asList(new FlammableReaction(20*3, false))),
    PH3("PH3", 0xFFFFFF, Arrays.asList(new FlammableReaction(20*3, false), new PoisonousReaction(5, 800, 2), new CorrosiveReaction())),
    H2S("H2S", 0xFFFFFF, Arrays.asList(new ExplosiveReaction(1, true), new PoisonousReaction(4, 400, 1))),
