# <img src="src/main/resources/assets/scicraft/icon.png" height=50px/> MineLabs 
...
For new developers who don't have much experience with modding, we advise to take a look at the [Fabric wiki](https://fabricmc.net/wiki/doku.php#developing_with_fabric) and send a message to @Kernteam Development on Discord. We would gladly help you get started!
