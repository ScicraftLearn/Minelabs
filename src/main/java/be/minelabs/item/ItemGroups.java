...
public class ItemGroups {
    ...
    public static final ItemGroup CHEMICALS = Registry.register(Registries.ITEM_GROUP,
            new Identifier(Minelabs.MOD_ID, "chemicals"), FabricItemGroup.builder()
                    ...
                    .displayName(Text.translatable("itemGroup.minelabs.chemicals"))
                    .entries((displayContext, entries) -> {
    ...
    public static final ItemGroup ATOMS = Registry.register(Registries.ITEM_GROUP,
            new Identifier(Minelabs.MOD_ID, "atoms"), FabricItemGroup.builder()
                    .icon(() -> new ItemStack(Atom.HYDROGEN.getItem()))
                    .displayName(Text.translatable("itemGroup.minelabs.atoms"))
                    .entries((displayContext, entries) -> entries.addAll(Items.ATOMS.stream().map(ItemStack::new).toList()))
                    .build());

    public static final ItemGroup ELEMENTARY_PARTICLES = Registry.register(Registries.ITEM_GROUP,
            new Identifier(Minelabs.MOD_ID, "elementary_particles"), FabricItemGroup.builder()
                    .icon(() -> new ItemStack(Items.PION_NUL))
                    .displayName(Text.translatable("itemGroup.minelabs.elementary_particles"))
                    .entries((displayContext, entries) -> {
    ...
    public static final ItemGroup QUANTUM_FIELDS = Registry.register(Registries.ITEM_GROUP,
            new Identifier(Minelabs.MOD_ID, "quantum_fields"), FabricItemGroup.builder()
                    .icon(() -> new ItemStack(Items.GLUON_QUANTUMFIELD))
                    .displayName(Text.translatable("itemGroup.minelabs.quantum_fields"))
                    .entries((displayContext, entries) -> {
