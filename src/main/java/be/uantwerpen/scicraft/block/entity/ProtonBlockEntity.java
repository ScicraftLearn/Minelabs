...
public class ProtonBlockEntity extends BlockEntity {
    ...
    public ProtonBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.PROTON_BLOCK_ENTITY, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, ProtonBlockEntity be) {
