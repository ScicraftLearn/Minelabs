...
public class ErlenmeyerItem extends Item implements FluidModificationItem, IMoleculeItem {
    ...
    public static ItemStack getEmptiedStack(ItemStack stack, PlayerEntity player) {
        return !player.getAbilities().creativeMode ? new ItemStack(be.minelabs.item.Items.ERLENMEYER) : stack;
    }
            ...
            if (!bl2) {
                ...
                if (!world.setBlockState(pos, this.fluid.getDefaultState().getBlockState(), 11) && !blockState.getFluidState().isStill()) {
                    ...
                    if (player instanceof ServerPlayerEntity serverPlayer)
                        be.minelabs.advancement.criterion.Criteria.ERLENMEYER_CRITERION.trigger(serverPlayer, ErlenmeyerCriterion.Type.POUR);
                    return true;
                }
            }
        }
