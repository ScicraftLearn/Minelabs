...
public enum Atom {
    ...
    CURIUM(96, "Cm", 1.3, AtomType.ACTINOID, 8, 151, Color.GRAY),
    BERKELIUM(97, "Bk", 1.3, AtomType.ACTINOID, 8, 150, Color.GRAY),
    CALIFORNIUM(98, "Cf", 1.3, AtomType.ACTINOID, 8, 153, Color.GRAY),
    EINSTEINIUM(99, "Es", 1.3, AtomType.ACTINOID, 8, 153, Color.GRAY),
    FERMIUM(100, "Fm", 1.3, AtomType.ACTINOID, 8, 157, Color.GRAY),
    MENDELEVIUM(101, "Md", 1.3, AtomType.ACTINOID, 8, 157, Color.GRAY),
    NOBELIUM(102, "No", 1.3, AtomType.ACTINOID, 8, 157, Color.GRAY),
    LAWRENCIUM(103, "Lr", 1.3, AtomType.ACTINOID, 8, 159, Color.GRAY),
    RUTHERFORDIUM(104, "Rf", 1.3, AtomType.TRANSITION_METAL, 4, 267, Color.GRAY),
    DUBNIUM(105, "Db", 1.3, AtomType.TRANSITION_METAL, 5, 270, Color.GRAY),
    SEABORGIUM(106, "Sg", 1.3, AtomType.TRANSITION_METAL, 6, 271, Color.GRAY),
    BOHRIUM(107, "Bh", 1.3, AtomType.TRANSITION_METAL, 7, 270, Color.GRAY),
    HASSIUM(108, "Hs", 1.3, AtomType.TRANSITION_METAL, 8, 277, Color.GRAY),
    MEITNERIUM(109, "Mt", 1.3, AtomType.UNKNOWN, 9, 278, Color.GRAY),
    DARMSTADTIUM(110, "Ds", 1.3, AtomType.UNKNOWN, 10, 281, Color.GRAY),
    ROENTGENIUM(111, "Rg", 1.3, AtomType.UNKNOWN, 11, 282, Color.GRAY),
    COPERNICIUM(112, "Cn", 1.3, AtomType.UNKNOWN, 12, 285, Color.GRAY),
    NIHONIUM(113, "Nh", 1.3, AtomType.UNKNOWN, 13, 286, Color.GRAY),
    FLEROVIUM(114, "Fl", 1.3, AtomType.POST_TRANSITION_METAL, 14, 289, Color.GRAY),
    MOSCOVIUM(115, "Mc", 1.3, AtomType.UNKNOWN, 15, 288, Color.GRAY),
    LIVERMORIUM(116, "Lv", 1.3, AtomType.UNKNOWN, 16, 293, Color.GRAY),
